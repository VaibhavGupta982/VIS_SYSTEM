	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out=response.getWriter();
		  out.println("<!DOCTYPE html>");
			...
			out.println("<form class='form-horizontal form-material' action='AdminCheckLogin' method='post'>");
			out.println(" <h3 class='box-title m-b-20'><center>Administrative Sign In</center></h3> <center><img src='logo.png' class='img'></center><br><br>");
			out.println("                        <div class='form-group '>");
			out.println("                            <div class='col-xs-12'>");
			out.println("                                <input class='form-control' type='text' required='' name='adminid' placeholder='Admin ID'> </div>");
			out.println("                        </div>");
			out.println("                        <div class='form-group'>");
			out.println("                            <div class='col-xs-12'>");
