...
$('document').ready(function(){
	...
	{var htm='<link href="asset/bootstrap.min.css" rel="stylesheet" type="text/css"><link href="admin/main/css/style.css" rel="stylesheet">'
		$.each(data,function(index,item){
			...
			htm+="<td style='text-align: center; vertical-align: middle;'><img src=images/"+item.ICON+" width='80' height='80'></td><td valign='top'><b>Event:</b>"+item.EVENTNAME+" [Duration:"+item.DAYS+"] Organized by "+item.ORGANIZEDBY+"<br>";
