...
public class Index extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 PrintWriter out=response.getWriter();
		  out.println("<html>");
			...
			out.println("                                <span class='icon-bar'></span>");
			out.println("                            </button>");
			out.println("                            <a class='navbar-brand' href='First.java'>");
		...
		//	out.println("                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>");
			...
			/*out.println("                        <div class='text-left' class='w-100 p-3'> ");
			   out.println("                         <img src='https://media.giphy.com/media/OkJat1YNdoD3W/giphy.gif' class='img-fluid' alt='WELCOME'>");
				out.println("                        </div>");*/
		out.println("                <div class='container'>");
