...
public class EmployeeHome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//	out.println("                            <img src='admin/assets/images/logo-light-icon.png' alt='homepage' class='light-logo' />");
			...
			out.println("<li><a class='has-arrow waves-effect waves-dark' href='UserEvenPage' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'> Add Employee</span></a></li>");
